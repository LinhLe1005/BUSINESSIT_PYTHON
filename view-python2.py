...
with st.sidebar:
    ...
    st.text("Description: The webiste was the second project of MATLAB & Python part of the Business IT2 course. This page was prepared by Group 10 in Thursday morning class under the guidance of Dr. Do Duc Tan.")
