...
with tab1:
    ...
    fig1.update_layout(title_font=dict(color='violet', size=22))
...
with tab2:
    ...
    # Update the layout to change the title color
    fig2.update_layout(title_font=dict(color='violet', size=18))
...
with tab3:
    ...
    # Update the layout to change the title color
    fig3.update_layout(title_font=dict(color='violet', size=24))
